...
public class RingUtil {
    ...
    public static void silentSwitchOn(Context mContext) {
        AudioManager audioManager = (AudioManager) mContext.getSystemService(Context.AUDIO_SERVICE);
        if (audioManager != null) {
//            audioManager.setRingerMode(AudioManager.RINGER_MODE_SILENT);
//            audioManager.getStreamVolume(AudioManager.STREAM_RING);
//            audioManager.getStreamVolume(AudioManager.STREAM_MUSIC);
            SPUtils.getInstance().put("jingyin", audioManager.getStreamVolume(AudioManager.STREAM_MUSIC));
            audioManager.setStreamVolume(AudioManager.STREAM_MUSIC, 0, 0);
            Log.d("Silent:", "RINGING 已被静音");
        }
    }

    public static void silentSwitchOff(Context mContext) {
        AudioManager audioManager = (AudioManager) mContext.getSystemService(Context.AUDIO_SERVICE);
        if (audioManager != null) {
//            audioManager.setRingerMode(AudioManager.RINGER_MODE_NORMAL);
//            audioManager.getStreamVolume(AudioManager.STREAM_RING);
//            audioManager.getStreamVolume(AudioManager.STREAM_MUSIC);
            audioManager.setStreamVolume(AudioManager.STREAM_MUSIC, SPUtils.getInstance().getInt("jingyin", 0), 0);
