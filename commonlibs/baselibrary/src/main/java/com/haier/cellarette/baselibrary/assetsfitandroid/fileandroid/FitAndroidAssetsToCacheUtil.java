...
public class FitAndroidAssetsToCacheUtil {
     ...
     * @return
     */
    public static File getAssetsHuanCunLujing(Activity activity, String file_name, String file_assets_lujing) {
        readAssertResource(activity, file_name, file_assets_lujing);// 刷新缓存区
     ...
     */
    public static void readAssertResourceBeifen(Activity activity, String file_name, String strAssertFileName) {
     ...
     * @param assets_url
     */
    public static void readAssertResource(Activity activity, String strAssertFileName, String assets_url) {
