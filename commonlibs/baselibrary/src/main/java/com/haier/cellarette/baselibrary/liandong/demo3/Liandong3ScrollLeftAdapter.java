...
public class Liandong3ScrollLeftAdapter extends BaseQuickAdapter<String, BaseViewHolder> {

    private List<TextView> tv = new ArrayList<>();

    public Liandong3ScrollLeftAdapter(int layoutResId, @Nullable List<String> data) {
