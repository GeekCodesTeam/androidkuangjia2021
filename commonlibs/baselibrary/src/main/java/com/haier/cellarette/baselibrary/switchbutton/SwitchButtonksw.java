...
public class SwitchButtonksw extends CompoundButton {
    ...
    public SwitchButtonksw(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(attrs);
    }

    public SwitchButtonksw(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public SwitchButtonksw(Context context) {
        super(context);
        init(null);
    }
    ...
    private void init(AttributeSet attrs) {
        ...
        if (ta != null) {
            thumbDrawable = ta.getDrawable(R.styleable.SwitchButtonksw_kswThumbDrawable);
            thumbColor = ta.getColorStateList(R.styleable.SwitchButtonksw_kswThumbColor);
            margin = ta.getDimension(R.styleable.SwitchButtonksw_kswThumbMargin, margin);
            marginLeft = ta.getDimension(R.styleable.SwitchButtonksw_kswThumbMarginLeft, margin);
            marginRight = ta.getDimension(R.styleable.SwitchButtonksw_kswThumbMarginRight, margin);
            marginTop = ta.getDimension(R.styleable.SwitchButtonksw_kswThumbMarginTop, margin);
            marginBottom = ta.getDimension(R.styleable.SwitchButtonksw_kswThumbMarginBottom, margin);
            thumbWidth = ta.getDimension(R.styleable.SwitchButtonksw_kswThumbWidth, thumbWidth);
            thumbHeight = ta.getDimension(R.styleable.SwitchButtonksw_kswThumbHeight, thumbHeight);
            thumbRadius = ta.getDimension(R.styleable.SwitchButtonksw_kswThumbRadius, thumbRadius);
            backRadius = ta.getDimension(R.styleable.SwitchButtonksw_kswBackRadius, backRadius);
            backDrawable = ta.getDrawable(R.styleable.SwitchButtonksw_kswBackDrawable);
            backColor = ta.getColorStateList(R.styleable.SwitchButtonksw_kswBackColor);
            thumbRangeRatio = ta.getFloat(R.styleable.SwitchButtonksw_kswThumbRangeRatio, thumbRangeRatio);
            animationDuration = ta.getInteger(R.styleable.SwitchButtonksw_kswAnimationDuration, animationDuration);
            fadeBack = ta.getBoolean(R.styleable.SwitchButtonksw_kswFadeBack, true);
            tintColor = ta.getColor(R.styleable.SwitchButtonksw_kswTintColor, tintColor);
            textOn = ta.getString(R.styleable.SwitchButtonksw_kswTextOn);
            textOff = ta.getString(R.styleable.SwitchButtonksw_kswTextOff);
            textThumbInset = ta.getDimensionPixelSize(R.styleable.SwitchButtonksw_kswTextThumbInset, 0);
            textExtra = ta.getDimensionPixelSize(R.styleable.SwitchButtonksw_kswTextExtra, 0);
            textAdjust = ta.getDimensionPixelSize(R.styleable.SwitchButtonksw_kswTextAdjust, 0);
            ta.recycle();
        }
