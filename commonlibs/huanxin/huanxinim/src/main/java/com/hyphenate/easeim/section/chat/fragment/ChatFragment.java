...
public class ChatFragment extends EaseChatFragment implements OnRecallMessageResultListener {
    ...
    public void onChatExtendMenuItemClick(View view, int itemId) {
        ...
        if (itemId == R.id.extend_item_video_call) {
            showSelectDialog();
        } else if (itemId == R.id.extend_item_conference_call) {
        ...
        } else if (itemId == R.id.extend_item_delivery) {//群消息回执
            showDeliveryDialog();
        } else if (itemId == R.id.extend_item_user_card) {
