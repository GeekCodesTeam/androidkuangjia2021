...
public class BaseEMRepository {
     ...
     */
    public void initDb() {
        DemoDbHelper.getInstance(BaseApp.get()).initDb(getCurrentUser());
    }
    ...
    public EmUserDao getUserDao() {
        return DemoDbHelper.getInstance(BaseApp.get()).getUserDao();
    }
    ...
    public MsgTypeManageDao getMsgTypeManageDao() {
        return DemoDbHelper.getInstance(BaseApp.get()).getMsgTypeManageDao();
    }
    ...
    public InviteMessageDao getInviteMessageDao() {
        return DemoDbHelper.getInstance(BaseApp.get()).getInviteMessageDao();
    }
