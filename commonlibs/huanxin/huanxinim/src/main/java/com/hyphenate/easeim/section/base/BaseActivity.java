...
import com.hyphenate.easeim.section.login.activity.IMLoginActivity;
...
public class BaseActivity extends AppCompatActivity {
    ...
    private Handler handler = new Handler(Looper.myLooper());//用于dialog延迟消失
            ...
            if (TextUtils.equals(accountEvent, DemoConstant.ACCOUNT_REMOVED) ||
                ...
                DemoHelper.getInstance().logout(false, new EMCallBack() {
                    ...
                    public void onSuccess() {
                        ...
                        startActivity(new Intent(mContext, IMLoginActivity.class));
                        finish();
                    }
...
//        ActivityUtils.finishOtherActivities(ActivityUtils.getTopActivity().getClass());
