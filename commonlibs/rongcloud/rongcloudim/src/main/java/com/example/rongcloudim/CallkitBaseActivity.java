...
public abstract class CallkitBaseActivity extends Base {
    private LinearLayout linearLayout;
    private Button btn_login1,btn_login2;
    private static final String TAG = CallkitBaseActivity.class.getName();
    private String localUserId="";

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout_callkit_base);
    ...
    public  void callkitloginClick(View view){
        int id = view.getId();
