...
package com.geek.swipebacklayout.demo;
...
import com.geek.swipebacklayout.R;
import com.geek.swipebacklayout.SwipeBackLayout;
import com.geek.swipebacklayout.activity.SwipeBackActivity;
...
//        changeActionBarColor();
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_start) {
            startActivity(new Intent(SwipebacklayoutDemoActivity.this, SwipebacklayoutDemoActivity.class));
