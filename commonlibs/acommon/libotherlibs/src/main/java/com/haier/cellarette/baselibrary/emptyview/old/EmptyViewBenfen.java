...
public class EmptyViewBenfen extends FrameLayout implements View.OnClickListener {
    ...
    public EmptyViewBenfen(Context context) {
        this(context, null, 0);
    }

    public EmptyViewBenfen(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EmptyViewBenfen(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        }
     ...
     * @return
     */
    public EmptyViewBenfen bind(View view) {
        mBindView = view;
        return this;
    }
     ...
     * @return
     */
    public EmptyViewBenfen notices(String... notices) {
