...
public class YanzhengUtil {
    ...
    public static Pattern p = Pattern.compile("^[\u4E00-\u9FA50-9a-zA-Z_!@#$&*+=.|]+$");
...
//        String deviceId = JCoreInterface.getUdid(context);
    ...
    public static String getImei(Context context, String imei) {
        ...
        try {
            ...
            Log.e(YanzhengUtil.class.getSimpleName(), e.getMessage());
        }
