...
//        drawerLayout.setDrawerLockMode(DrawerLayout.LOCK_MODE_UNLOCKED); //打开手势滑动
        drawerbar = new ActionBarDrawerToggle(CoordinatorLayoutAct5.this, drawerLayout, toolbar,
                R.string.navigation_drawer_open, R.string.navigation_drawer_close) {
            //菜单打开
            @Override
            public void onDrawerOpened(View drawerView) {
                super.onDrawerOpened(drawerView);
                Toast.makeText(CoordinatorLayoutAct5.this, "菜单打开", Toast.LENGTH_SHORT).show();
            }
            ...
            public void onDrawerClosed(View drawerView) {
                ...
                Toast.makeText(CoordinatorLayoutAct5.this, "菜单关闭", Toast.LENGTH_SHORT).show();
            }
        };
