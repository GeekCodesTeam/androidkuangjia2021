...
public class SwitchButtonK extends CompoundButton {
    ...
    public SwitchButtonK(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(attrs);
    }

    public SwitchButtonK(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public SwitchButtonK(Context context) {
        super(context);
        init(null);
    }
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray ta = attrs == null ? null : getContext().obtainStyledAttributes(attrs, R.styleable.SwitchButtonK);
        if (ta != null) {
            thumbDrawable = ta.getDrawable(R.styleable.SwitchButtonK_kswThumbDrawable);
            thumbColor = ta.getColorStateList(R.styleable.SwitchButtonK_kswThumbColor);
            margin = ta.getDimension(R.styleable.SwitchButtonK_kswThumbMargin, margin);
            marginLeft = ta.getDimension(R.styleable.SwitchButtonK_kswThumbMarginLeft, margin);
            marginRight = ta.getDimension(R.styleable.SwitchButtonK_kswThumbMarginRight, margin);
            marginTop = ta.getDimension(R.styleable.SwitchButtonK_kswThumbMarginTop, margin);
            marginBottom = ta.getDimension(R.styleable.SwitchButtonK_kswThumbMarginBottom, margin);
            thumbWidth = ta.getDimension(R.styleable.SwitchButtonK_kswThumbWidth, thumbWidth);
            thumbHeight = ta.getDimension(R.styleable.SwitchButtonK_kswThumbHeight, thumbHeight);
            thumbRadius = ta.getDimension(R.styleable.SwitchButtonK_kswThumbRadius, thumbRadius);
            backRadius = ta.getDimension(R.styleable.SwitchButtonK_kswBackRadius, backRadius);
            backDrawable = ta.getDrawable(R.styleable.SwitchButtonK_kswBackDrawable);
            backColor = ta.getColorStateList(R.styleable.SwitchButtonK_kswBackColor);
            thumbRangeRatio = ta.getFloat(R.styleable.SwitchButtonK_kswThumbRangeRatio, thumbRangeRatio);
            animationDuration = ta.getInteger(R.styleable.SwitchButtonK_kswAnimationDuration, animationDuration);
            fadeBack = ta.getBoolean(R.styleable.SwitchButtonK_kswFadeBack, true);
            tintColor = ta.getColor(R.styleable.SwitchButtonK_kswTintColor, tintColor);
            textOn = ta.getString(R.styleable.SwitchButtonK_kswTextOn);
            textOff = ta.getString(R.styleable.SwitchButtonK_kswTextOff);
            textThumbInset = ta.getDimensionPixelSize(R.styleable.SwitchButtonK_kswTextThumbInset, 0);
            textExtra = ta.getDimensionPixelSize(R.styleable.SwitchButtonK_kswTextExtra, 0);
            textAdjust = ta.getDimensionPixelSize(R.styleable.SwitchButtonK_kswTextAdjust, 0);
            ta.recycle();
        }
