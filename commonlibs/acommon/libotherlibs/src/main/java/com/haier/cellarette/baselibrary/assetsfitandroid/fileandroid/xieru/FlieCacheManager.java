...
public class FlieCacheManager {
    ...
    //    private static final String PATH = getExternalFilesDir(null).getPath() + File.separator + "goods";
     ...
     */
    public FlieCacheManager addHashMap(String storeId, HashMap<String, ? extends Object> storeGoodsBean) {
...
//            fileOutputStream = new FileOutputStream(file.getAbsolutePath() + File.separator + storeId + FILE_FORMAT);
    ...
    public <T> HashMap<String, ? extends T> getHashMap(String storeId) {
        ...
        HashMap<String, ? extends T> storeGoodsBean = new HashMap<>(16);
        try {
