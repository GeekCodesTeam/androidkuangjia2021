...
public class BannerView extends FrameLayout {
    ...
    public BannerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        initView(context, normalColor, currentColor, currentStyle, currentSize, circleRadius, paddings);
    }

    private void initView(Context context, int normalColor, int currentColor, int currentStyle,
                          int currentSize, int circleRadius, int paddings) {
        mViewPager = new ViewPager(context);
        mViewPager.addOnPageChangeListener(mOnPageChangeListener);
        addView(mViewPager);//, viewPagerParams);

        mHandler = new H(mViewPager);
        mIndicator = new DotIndicatorView(context, normalColor, currentColor, currentStyle, currentSize, circleRadius, paddings);
