 ...
 *  int minute_service = Integer.parseInt(String.valueOf(times[2]));
 *  int second_service = Integer.parseInt(String.valueOf(times[3]));
 *  tvTime.setText(time_change_one(minute_service) + " : " + time_change_one(second_service));
 *
 *  180000000  = 18:16:02:30
 *
 */
public class DaojishiUtil {
    ...
    public static String time_change_two(String data) {
        ...
        if ("0".equals(String.valueOf(chars[0]))) {
