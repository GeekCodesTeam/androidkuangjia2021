...
//    private Integer[] Layouts = {R.layout.splash_activity_lay1, R.layout.splash_activity_lay2, R.layout.splash_activity_lay3, R.layout.splash_activity_lay4};
    ...
    private void init(Context context) {
        ...
        view = from.inflate(R.layout.activity_splash_base, this, true);
//        view = from.inflate(R.layout.activity_splash, null);

        vg = view.findViewById(R.id.guide_ll_point_base);
        vp = view.findViewById(R.id.guide_vp_base);
        relativeLayout = view.findViewById(R.id.rl_base);
    }
