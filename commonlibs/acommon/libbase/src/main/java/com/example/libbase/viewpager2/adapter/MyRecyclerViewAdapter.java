package com.example.libbase.viewpager2.adapter;
...
public class MyRecyclerViewAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType== R.layout.lunbo_item) {
            return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.lunbo_item, parent, false));
        }else{
            return new MyBannerViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.lunbo_banner, parent, false));
        }
    }
