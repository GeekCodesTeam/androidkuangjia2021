...
//<com.haier.cellarette.baselibrary.shuaxinviewanimation.LxShimmerLayout
...
public class LxShimmerLayout extends FrameLayout {
    ...
    public LxShimmerLayout(Context context) {
        this(context, null);
    }

    public LxShimmerLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LxShimmerLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(
                attrs,
                R.styleable.LxShimmerLayout,
                0, 0);

        try {
            shimmerAngle = a.getInteger(R.styleable.LxShimmerLayout_shimmer_angle, DEFAULT_ANGLE);
            shimmerAnimationDuration = a.getInteger(R.styleable.LxShimmerLayout_shimmer_animation_duration, DEFAULT_ANIMATION_DURATION);
//            shimmerColor = a.getColor(R.styleable.ShimmerLayout_shimmer_color, getColor(R.color.shimmer_color));
            shimmerColor = a.getColor(R.styleable.LxShimmerLayout_shimmer_color, Color.parseColor("#a2878787"));
            autoStart = a.getBoolean(R.styleable.LxShimmerLayout_shimmer_auto_start, false);
            maskWidth = a.getFloat(R.styleable.LxShimmerLayout_shimmer_mask_width, 0.5F);
            gradientCenterColorWidth = a.getFloat(R.styleable.LxShimmerLayout_shimmer_gradient_center_color_width, 0.1F);
            isAnimationReversed = a.getBoolean(R.styleable.LxShimmerLayout_shimmer_reverse_animation, false);
        } finally {
            a.recycle();
        }
