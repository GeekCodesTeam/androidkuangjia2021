 ...
 */
package com.haier.cellarette.baselibrary.lobsterpicker.sliders;
...
import com.haier.cellarette.baselibrary.lobsterpicker.ColorDecorator;
import com.haier.cellarette.baselibrary.lobsterpicker.LobsterPicker;
import com.haier.cellarette.baselibrary.lobsterpicker.LobsterSlider;
...
public class LobsterShadeSlider extends LobsterSlider {
    ...
    private ColorDecorator updateDecorator = new ColorDecorator() {
        @Override
        public void onColorChanged(LobsterPicker.Chain chain, @ColorInt int color) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        int schemeRes = a.getResourceId(
                R.styleable.LobsterShadeSlider_color_slider_scheme, R.drawable.default_shader_pallete11);
        a.recycle();
    ...
    public String adjustAlpha(int color, float factor) {
        int alpha = Math.round(Color.alpha(color) * factor);
        int red = Color.red(color);
        int green = Color.green(color);
        int blue = Color.blue(color);
        int aaa = Color.argb(alpha, red, green, blue);
        return "#" + Integer.toHexString(aaa);
