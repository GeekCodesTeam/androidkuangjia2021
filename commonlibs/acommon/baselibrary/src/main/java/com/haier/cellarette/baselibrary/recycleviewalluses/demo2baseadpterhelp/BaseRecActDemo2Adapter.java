...
public class BaseRecActDemo2Adapter extends BaseQuickAdapter<BaseRecActDemo2Bean, BaseViewHolder> {

    public BaseRecActDemo2Adapter(int layoutResId) {
        super(layoutResId);
    }

    @Override
    protected void convert(BaseViewHolder helper, BaseRecActDemo2Bean item) {
