...
public class StyleInCodeActivitySwitchButtonK extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChangeSb = (SwitchButtonK) findViewById(R.id.sb_code);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        switch (position) {
            ...
            case 5: {
                ...
                float defaultMargin = SwitchButtonK.DEFAULT_THUMB_MARGIN_DP * getResources().getDisplayMetrics().density;
            ...
            case 9:
                ...
                break;
            case 10:
                mChangeSb.setThumbRangeRatio(mBackMeasureRatioFlag ? SwitchButtonK.DEFAULT_THUMB_RANGE_RATIO : 4f);
                mBackMeasureRatioFlag = !mBackMeasureRatioFlag;
                break;
            case 11:
                mChangeSb.setAnimationDuration(mAnimationDurationFlag ? SwitchButtonK.DEFAULT_ANIMATION_DURATION : 1000);
