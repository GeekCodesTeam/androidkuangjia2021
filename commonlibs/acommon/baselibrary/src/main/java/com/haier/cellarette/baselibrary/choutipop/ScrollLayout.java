...
public class ScrollLayout extends ViewGroup {
    ...
    private void init(Context context) {
        ...
        slideSlop = ChoutiScreenUtils.dpToPxInt(context, 45);
        offsetB = ChoutiScreenUtils.dpToPxInt(context, 40);
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                Log.i("liuyzz--onAnimation--:", "" + factor);
                //curY可为负数或正数
    ...
    public void setHeights(int heights) {
        //界面下边显示出来的子View的高度
        this.child_default_height = heights;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //界面下边显示出来的子View的高度
        child_default_height = ChoutiScreenUtils.dpToPxInt(getContext(), 600);
        offsetY = height - child_default_height;
        offsetExtend = offsetY - offsetB;
        offsetClose = offsetY + offsetB - height;//负数 向下移动到剩下40dp的高度
        offsetDefault = 0;
