package com.haier.cellarette.baselibrary.btnonclick.view;
...
public class BounceView implements BounceViewAnim {
    ...
    private void setAnimToDialog() {
        if (dialog.get() != null) {
            ...
            dialogWindow.setWindowAnimations(R.style.CustomDialogAnimation2);
        }
    }

    private void setAnimToPopup() {
        if (popup.get() != null) {
            popup.get().setAnimationStyle(R.style.CustomDialogAnimation2);
        }
    }
