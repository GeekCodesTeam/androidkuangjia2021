 ...
 * 自定义的IjkVideoView
 */
public class CustomIjkPlayerActivityDk extends BaseActivityDk<IjkVideoViewDk> implements View.OnClickListener {
    ...
    protected int getLayoutResId() {
        return R.layout.activity_custom_ijk_playerdk;
    }
