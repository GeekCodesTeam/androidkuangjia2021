 ...
 * 调试信息
 */
public class DebugInfoViewDk extends AppCompatTextView implements IControlComponent {

    private ControlWrapper mControlWrapper;

    public DebugInfoViewDk(Context context) {
        super(context);
    }

    public DebugInfoViewDk(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DebugInfoViewDk(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected String getDebugString(int playState) {
        return getCurrentPlayer() + UtilsDk.playState2str(playState) + "\n"
