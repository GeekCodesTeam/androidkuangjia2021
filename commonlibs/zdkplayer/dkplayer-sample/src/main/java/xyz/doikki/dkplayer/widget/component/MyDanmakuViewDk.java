...
public class MyDanmakuViewDk extends DanmakuView implements IControlComponent {

    private DanmakuContext mContext;
    private BaseDanmakuParser mParser;

    public MyDanmakuViewDk(@NonNull Context context) {
        super(context);
    }

    public MyDanmakuViewDk(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public MyDanmakuViewDk(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        danmaku.borderColor = Color.GREEN;
    ...
    private SpannableStringBuilder createSpannable(Drawable drawable) {
        ...
        CenteredImageSpanDk span = new CenteredImageSpanDk(drawable);//ImageSpan.ALIGN_BOTTOM);
