 ...
 * 多开
 */
public class ParallelPlayActivityDk extends AppCompatActivity {

    private static final String VOD_URL_1 = "http://vfx.mtime.cn/Video/2019/03/18/mp4/190318231014076505.mp4";
    private static final String VOD_URL_2 = DataUtilDk.SAMPLE_URL;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parallel_playdk);
