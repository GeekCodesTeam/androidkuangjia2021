...
public class AndroidOPiPActivityDk extends AppCompatActivity {
    /**
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pip_android_odk);
    ...
    void updatePictureInPictureActions(
        ...
        final PendingIntent intent =
                PendingIntent.getBroadcast(
                        AndroidOPiPActivityDk.this,
                        requestCode,
                        new Intent(ACTION_MEDIA_CONTROL).putExtra(EXTRA_CONTROL_TYPE, controlType),
                        0);
        final Icon icon = Icon.createWithResource(AndroidOPiPActivityDk.this, iconId);
