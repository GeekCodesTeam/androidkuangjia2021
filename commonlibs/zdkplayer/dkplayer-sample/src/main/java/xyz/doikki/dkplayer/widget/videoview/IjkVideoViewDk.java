...
import xyz.doikki.dkplayer.widget.player.CustomIjkMediaPlayerDk;
...
public class IjkVideoViewDk extends VideoView<CustomIjkMediaPlayerDk> {
    ...
    public IjkVideoViewDk(@NonNull Context context) {
        super(context);
    }

    public IjkVideoViewDk(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public IjkVideoViewDk(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    {
        setPlayerFactory(new PlayerFactory<CustomIjkMediaPlayerDk>() {
            @Override
            public CustomIjkMediaPlayerDk createPlayer(Context context) {
                return new CustomIjkMediaPlayerDk(context);
            }
        });
    }
