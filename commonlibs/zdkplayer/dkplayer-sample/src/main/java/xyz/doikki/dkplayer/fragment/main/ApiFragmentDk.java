...
public class ApiFragmentDk extends BaseFragmentDk implements View.OnClickListener {
...
//    private static final String VOD_URL = "http://vfx.mtime.cn/Video/2019/03/18/mp4/190318231014076505.mp4";
    private static final String VOD_URL = DataUtilDk.SAMPLE_URL;
...
//    private static final String LIVE_URL = "ijklivehook:rtmp://live.hkstv.hk.lxdns.com/live/hks";
    ...
    protected int getLayoutResId() {
        return R.layout.fragment_apidk;
    }
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_vod) {
            ...
            startActivity(new Intent(getActivity(), ParallelPlayActivityDk.class));
        }
    }
}
