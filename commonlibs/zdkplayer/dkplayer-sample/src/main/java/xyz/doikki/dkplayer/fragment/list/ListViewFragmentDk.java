...
import xyz.doikki.dkplayer.adapter.VideoListViewAdapterDk;
...
/**
 * ListView demo，不推荐，建议使用{@link RecyclerViewFragmentDk}
 */
public class ListViewFragmentDk extends BaseFragmentDk implements OnItemChildClickListenerDk {

    private List<VideoBeanDk> mVideos = new ArrayList<>();
    private VideoListViewAdapterDk mAdapter;
    ...
    protected int getLayoutResId() {
        return R.layout.fragment_list_viewdk;
    }
    ...
    protected void initView() {
        ...
        mAdapter = new VideoListViewAdapterDk(mVideos);
    ...
    public void onItemChildClick(int position) {
        ...
        VideoListViewAdapterDk.ViewHolder viewHolder = (VideoListViewAdapterDk.ViewHolder) itemView.getTag();
