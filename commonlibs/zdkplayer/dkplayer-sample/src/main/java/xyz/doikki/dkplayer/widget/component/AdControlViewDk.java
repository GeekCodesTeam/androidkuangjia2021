...
public class AdControlViewDk extends FrameLayout implements IControlComponent, View.OnClickListener {
    ...
    public AdControlViewDk(@NonNull Context context) {
        super(context);
    }

    public AdControlViewDk(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public AdControlViewDk(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    {
        LayoutInflater.from(getContext()).inflate(R.layout.layout_ad_control_viewdk, this, true);
