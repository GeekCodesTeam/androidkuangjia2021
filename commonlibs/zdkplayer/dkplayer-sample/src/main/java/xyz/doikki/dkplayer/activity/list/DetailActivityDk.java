...
public class DetailActivityDk extends BaseActivityDk<VideoView> {
    ...
    protected int getLayoutResId() {
        return R.layout.activity_detaildk;
    }
    ...
    private void initVideoView() {
        ...
        //设置新的控制器
        StandardVideoController controller = new StandardVideoController(DetailActivityDk.this);
        mVideoView.setVideoController(controller);

        Intent intent = getIntent();
        boolean seamlessPlay = intent.getBooleanExtra(IntentKeysDk.SEAMLESS_PLAY, false);
