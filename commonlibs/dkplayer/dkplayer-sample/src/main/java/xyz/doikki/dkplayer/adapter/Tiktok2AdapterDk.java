...
public class Tiktok2AdapterDk extends PagerAdapter {
    ...
    public Tiktok2AdapterDk(List<TiktokBeanDk> videoBeans) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.item_tik_tokdk, container, false);
    ...
    public void destroyItem(@NonNull ViewGroup container, int position, @NonNull Object object) {
        ...
        TiktokBeanDk item = mVideoBeans.get(position);
        //取消预加载
        PreloadManagerDk.getInstance(container.getContext()).removePreloadTask(item.videoDownloadUrl);
        //保存起来用来复用
