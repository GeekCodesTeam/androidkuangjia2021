...
public class PortraitWhenFullScreenControllerDk extends StandardVideoController {

    private View mFullScreen;

    public PortraitWhenFullScreenControllerDk(@NonNull Context context) {
        this(context, null);
    }

    public PortraitWhenFullScreenControllerDk(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PortraitWhenFullScreenControllerDk(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
