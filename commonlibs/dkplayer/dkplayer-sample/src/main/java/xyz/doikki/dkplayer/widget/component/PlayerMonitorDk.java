...
public class PlayerMonitorDk implements IControlComponent {
    ...
    public void onPlayStateChanged(int playState) {
        L.d("onPlayStateChanged: " + UtilsDk.playState2str(playState));
    }

    @Override
    public void onPlayerStateChanged(int playerState) {
        L.d("onPlayerStateChanged: " + UtilsDk.playerState2str(playerState));
    }
