...
public class PlayListActivityDk extends BaseActivityDk {

    private List<VideoBeanDk> data = DataUtilDk.getVideoList();
    ...
    protected void initView() {
        ...
        mController.addControlComponent(new PlayerMonitorDk());

        //加载第一条数据
        VideoBeanDk videoBean = data.get(0);
