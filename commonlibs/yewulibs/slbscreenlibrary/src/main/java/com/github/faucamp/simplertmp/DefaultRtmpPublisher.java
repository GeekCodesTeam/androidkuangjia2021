...
import net.ossrs.yasea.OnStopListener;
...
public class DefaultRtmpPublisher implements RtmpPublisher {
    ...
    public boolean isConnected() {
        return rtmpConnection.isConnected();
    }
    ...
    public void onMetaData(int orientation, boolean isStop) {
        rtmpConnection.onMetaData(orientation, isStop);
    }
}
