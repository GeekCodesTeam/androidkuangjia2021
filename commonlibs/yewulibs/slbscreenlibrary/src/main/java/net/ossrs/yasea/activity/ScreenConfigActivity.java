        ...
        if (requestCode == IntentIntegrator.REQUEST_CODE) {
            ...
            if (intentResult != null) {
                if (intentResult.getContents() == null) {
                    Toast.makeText(BaseApp.get(), "内容为空", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(BaseApp.get(), "扫描成功", Toast.LENGTH_LONG).show();
                    MyLogUtil.e("eeeee--url", "--" + intentResult.getContents());
                    // ScanResult 为 获取到的字符串
                    String url = intentResult.getContents();
//                        Gson gson = new Gson();
//                        Test test = gson.fromJson(url, Test.class);
//                        MyLogUtil.e("eeeee--url", "--" + url);
...
//                    http://o-pull.xczx-jn.com/live/test2/playlist.m3u8 观看录屏地址
                    ...
                    if (ServiceUtil.getInstance().mMediaProjection == null) {
                        ...
                        MyLogUtil.e("eeeee--", "投屏--mMediaProjection == null");
                    } else {
//                            EventBus.getDefault().post(Event.EVENT_CLOSE_SCREEN);
                        ...
                        MyLogUtil.e("eeeee--", "投屏--Event.EVENT_CLOSE_SCREEN");
                    }
                }
            }
        } else if (requestCode == REQUEST_MEDIA_PROJECTION_SCREEN) {
            MyLogUtil.e("eeeeerequestCode--", "REQUEST_MEDIA_PROJECTION_SCREEN");
...
//                EventBus.getDefault().post(Event.EVENT_CLOSE_SCREEN);
            MyLogUtil.e("eeeeerequestCode--", "进入投屏lib");
...
//            mButton.setText("重连中");
            MyLogUtil.e("eeeeelistener--", "重连中Connecting" + msg);
        }

        @Override
        public void onRtmpConnected(String msg) {
            MyLogUtil.e("eeeeelistener--", "录制中RtmpConnected" + msg);
//            mButton.setText("录制中");
...
//                });
        ...
        public void onRtmpStopped() {
            MyLogUtil.e("eeeee_TAG_RTMP", "onRtmpStopped");
        }

        @Override
        public void onRtmpDisconnected() {
            MyLogUtil.e("eeeee_TAG_RTMP", "链接onRtmpDisconnected");
        }

        @Override
        public void onRtmpException(Exception e) {
            MyLogUtil.e("eeeee_TAG_RTMP", "链接断开");
        }
    };
