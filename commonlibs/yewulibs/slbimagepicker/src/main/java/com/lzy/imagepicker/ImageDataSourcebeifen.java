 ...
 * ================================================
 */
public class ImageDataSourcebeifen implements LoaderManager.LoaderCallbacks<Cursor> {
     ...
     */
    public ImageDataSourcebeifen(FragmentActivity activity, String path, OnImagesLoadedListener loadedListener) {
