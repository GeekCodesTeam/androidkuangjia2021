...
public class SingleImagePhotoViewActivity extends AppCompatActivity {

    private PhotoView glideImageView;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_demo_image_yulan2);
    ...
    private void loadImage() {
        glideImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ActivityCompat.finishAfterTransition(SingleImagePhotoViewActivity.this);
            }
        });
        ...
        imageLoader.requestBuilder(image_url, requestOptionsWithoutCache)
                .thumbnail(Glide.with(SingleImagePhotoViewActivity.this)
