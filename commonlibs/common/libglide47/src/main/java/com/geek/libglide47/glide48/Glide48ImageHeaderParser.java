...
import static com.geek.libglide47.glide48.Glide48ImageType.GIF;
import static com.geek.libglide47.glide48.Glide48ImageType.JPEG;
import static com.geek.libglide47.glide48.Glide48ImageType.PNG;
import static com.geek.libglide47.glide48.Glide48ImageType.PNG_A;
import static com.geek.libglide47.glide48.Glide48ImageType.UNKNOWN;

/**
 * Description: copy from Glide.
 * Create by lxj, at 2019/3/4
 */
public class Glide48ImageHeaderParser {
    ...
    static Glide48ImageType getImageType(InputStream is) throws IOException {
        ...
        if ((fourthFourBytes & VP8_HEADER_TYPE_MASK) == VP8_HEADER_TYPE_EXTENDED) {
            ...
            reader.skip(4);
            return (reader.getByte() & WEBP_EXTENDED_ALPHA_FLAG) != 0 ? Glide48ImageType.WEBP_A : Glide48ImageType.WEBP;
        }
        if ((fourthFourBytes & VP8_HEADER_TYPE_MASK) == VP8_HEADER_TYPE_LOSSLESS) {
            ...
            // for more info.
            reader.skip(4);
            return (reader.getByte() & WEBP_LOSSLESS_ALPHA_FLAG) != 0 ? Glide48ImageType.WEBP_A : Glide48ImageType.WEBP;
        }
        is.close();
        return Glide48ImageType.WEBP;
    }
