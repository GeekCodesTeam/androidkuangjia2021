...
//    public static final String AGENTWEB_VERSION = AGENTWEB_NAME + "/" + BuildConfig.LIBRARY_PACKAGE_NAME;
    public static final String AGENTWEB_VERSION = AGENTWEB_NAME + "/" + AppUtils.getAppPackageName();
    /**
