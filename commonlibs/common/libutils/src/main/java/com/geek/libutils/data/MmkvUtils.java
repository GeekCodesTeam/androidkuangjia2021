...
public class MmkvUtils {
    ...
    public void get_demo() {
        ...
        MmkvUtils.getInstance().set_common_json("ceshi", JSON.toJSONString(biaoge_listBean), DemoMMKVBean.class);
        MmkvUtils.getInstance().set_common_json2("ceshi2", biaoge_listBean2);
        DemoMMKVBean bean = MmkvUtils.getInstance().get_common_json("ceshi", DemoMMKVBean.class);
        DemoMMKVBean bean2 = MmkvUtils.getInstance().get_common_json("ceshi2", DemoMMKVBean.class);
        ...
        MmkvUtils.getInstance().remove_common("ceshi3");
        MyLogUtil.e("--MmkvUtils-ceshi3-", MmkvUtils.getInstance().get_common("ceshi3") + "--");
        MmkvUtils.getInstance().remove_xiancheng_common("ceshi4");
        MyLogUtil.e("--MmkvUtils-ceshi4-", "----" + MmkvUtils.getInstance().get_xiancheng_string("ceshi4"));
    }
    ...
    public void get(String path) {
        ...
        if (TextUtils.isEmpty(path)) {
            rootDir = MMKV.initialize(BaseApp.get());
        } else {
