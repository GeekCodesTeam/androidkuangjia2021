...
public class RoomManager {
        ...
        okHttpClient.newCall(request)
                .enqueue(new Callback() {
                    ...
                    public void onFailure(Call call, IOException e) {
                        ...
                        if (callback != null) {
                            callback.onFailed(ERROR_CODE_UNKNOWN, TencentApp.get().getString(R.string.unknow_error));
                        }
                    }
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        if (!response.isSuccessful()) {
                            doFailed(ERROR_CODE_UNKNOWN, TencentApp.get().getString(R.string.unknow_error));
                            return;
                        }
    ...
    public void getScenesRoomInfos(final Context context, String type, final GetScenesRoomInfosCallback callback) {
        RoomManager.getInstance().getRoomList(type, new GetRoomListCallback() {
            @Override
