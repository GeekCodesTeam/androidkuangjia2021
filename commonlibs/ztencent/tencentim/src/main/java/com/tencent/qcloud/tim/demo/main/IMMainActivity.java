...
public class IMMainActivity extends BaseActivity implements ConversationManagerKit.MessageUnreadWatcher {
            ...
            new Thread() {
                ...
                public void run() {
                    try {
                        ...
                        String appId = AGConnectServicesConfig.fromContext(IMMainActivity.this).getString("client/app_id");
                        String token = HmsInstanceId.getInstance(IMMainActivity.this).getToken(appId, "HCM");
    ...
    public void tabClick(View view) {
        ...
        } else if (id == R.id.scenes_btn_group) {
    ...
    protected void onResume() {
        ...
        super.onResume();
        if (mCallModel != null) {
            TRTCAVCallImpl impl = (TRTCAVCallImpl) TRTCAVCallImpl.sharedInstance(TencentApp.get());
            impl.stopCall();
            ...
            ((TRTCAVCallImpl) (TRTCAVCallImpl.sharedInstance(TencentApp.get()))).processInvite(
