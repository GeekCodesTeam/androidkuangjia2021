package com.geek.libglide47.demo.view;
...
import com.geek.libglide47.demo.adapter.NineImageViewAdapter;
...
public class NineImageView extends ViewGroup {
    ...
    private boolean vis_more;                       // 是否显示的图片数
    ...
    private void loadImage(ImageView imageView, final ImageAttr attr, final int count) {
        ...
        if (imageView == null) {
            ...
            imageView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    mAdapter.onImageItemClick(getContext(), NineImageView.this, position, mAdapter.getImageAttrs());
                }
            });
    ...
    public boolean isVis_more() {
        return vis_more;
    }

    public void setVis_more(boolean vis_more) {
        this.vis_more = vis_more;
    }
}
