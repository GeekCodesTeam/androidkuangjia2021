...
public class Huxi2ViewActivity extends AppCompatActivity {
    ...
    public static void start(Context context, String type) {
        Intent intent = new Intent(context, Huxi2ViewActivity.class);
        intent.putExtra(PARAMS_TYPE, type);
        context.startActivity(intent);
    }

    public static class MyHandler extends android.os.Handler {
        private final WeakReference<Huxi2ViewActivity> activityWeakReference;

        MyHandler(Huxi2ViewActivity activity) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewhuxi2);
        ...
        if (TYPE_IMG_LOADING.equals(mType)) {
            skeletonScreen = Skeleton.bind(rootView)
                    .load(R.layout.layout_img_skeletonhuxi2)
                    .duration(1000)
