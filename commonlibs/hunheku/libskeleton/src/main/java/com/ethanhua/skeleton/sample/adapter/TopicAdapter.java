...
public class TopicAdapter extends RecyclerView.Adapter<SimpleRcvViewHolder> {
    ...
    public SimpleRcvViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_HEADER) {
            return new SimpleRcvViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_title_morehuxi2, parent, false));
        }
        return new SimpleRcvViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_topichuxi2, parent, false));
    }
