...
public class StatusBarUtil {
     ...
     * @param resid
     */
    public static void setThisStatusBarColor(final Activity activity, @DrawableRes final int resid) {
        activity.getWindow().getDecorView().addOnLayoutChangeListener(new View.OnLayoutChangeListener() {
            @Override
            public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
                initStatusBar(activity, resid);
    ...
    private static void initStatusBar(Activity activity, @DrawableRes int resid) {
        //利用反射机制修改状态栏背景
