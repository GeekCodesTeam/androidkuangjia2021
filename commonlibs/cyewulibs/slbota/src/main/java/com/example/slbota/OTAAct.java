...
//        MmkvUtils.getInstance().get_demo();
    ...
    private void initFileDownLoader() {
        FileDownloader.setupOnApplicationOnCreate(OTAApp.get())
...
//        APKPresenter.getIndexAdvertisingData();
    ...
    private BroadcastReceiver romUpdataBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.d("OTA_ROM_FORCE_UPDATA", "---------极光推送部分------开启强制升级OS---------");
            Log.d("OTA_ROM_FORCE_UPDATA", "Push message：osId= " + mUpdateFlag);
            // TODO test
            // OTA
    ...
    private BroadcastReceiver apkUpdataBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            String mUpdateFlag = intent.getStringExtra("msg");
            Log.d("OTA_ROM_APK_UPDATA", "---------极光推送成功-------开启升级OS+APK---------");
            Log.d("OTA_ROM_APK_UPDATA", "Push message：osId = " + mUpdateFlag);
            // TODO test
            //TODO APK升级部分
