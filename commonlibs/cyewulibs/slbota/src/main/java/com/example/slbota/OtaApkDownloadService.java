...
//            String newFileDir = getExternalFilesDir(null) + OTASendUtils.DIR_DOWNLOAD;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null && !intent.getStringExtra("apkurl").isEmpty()) {
            ...
            Log.d(TAG, "download apkurl  is null");
            stopSelf();
        }
    ...
    private BaseDownloadTask createDownloadTask() {
        ...
        Log.d(TAG, "start download apk url" + urlIntent);
        return FileDownloader.getImpl().create(url)
                ...
                .setListener(new FileDownloadSampleListener() {
                    ...
                    protected void completed(BaseDownloadTask task) {
                        ...
                        Log.d(TAG, "apk download success");
                        //下载完成安装apk
                        installApk();
                    }
...
//        MsgViewManager.destory();
        ...
        Log.d(TAG, "apk download save path path =" + saveFile.toString());
...
//        startActivity(mIntent);
        ...
        OTAFileProvider7.setIntentDataAndType(this, i, "application/vnd.android.package-archive", saveFile, true);
        startActivity(i);
...
//            mIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//            startActivity(mIntent);
//            Log.d(TAG, "send upgrade apk broadcast success");
