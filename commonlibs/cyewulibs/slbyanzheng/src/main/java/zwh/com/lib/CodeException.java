...
public class CodeException {
    ...
    /*该次指纹识别失败*/
    public static final int FINGERPRINTERS_RECOGNIZE_FAILED= 0x7;


    @IntDef({SYSTEM_API_ERROR, PERMISSION_DENIED_ERROE, HARDWARE_MISSIING_ERROR, KEYGUARDSECURE_MISSIING_ERROR, NO_FINGERPRINTERS_ENROOLED_ERROR,FINGERPRINTERS_FAILED_ERROR,FINGERPRINTERS_RECOGNIZE_FAILED})
