...
//        viewHolder.tv_content_tag1.setText("图标：" + ratings.getDevice().getType());
        if (ratings.getStatus().equals(context.getResources().getString(R.string.bluetooth_tips5))) {
            viewHolder.tv_content_tag2.setTextColor(ContextCompat.getColor(context, R.color.red2));
            viewHolder.tv_content_tag3.setTextColor(ContextCompat.getColor(context, R.color.red2));
        } else {
            viewHolder.tv_content_tag2.setTextColor(ContextCompat.getColor(context, R.color.black_common));
            viewHolder.tv_content_tag3.setTextColor(ContextCompat.getColor(context, R.color.black_common));
        }
