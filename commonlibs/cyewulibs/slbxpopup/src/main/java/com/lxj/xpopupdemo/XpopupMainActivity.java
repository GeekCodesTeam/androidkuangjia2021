...
//        loadingPopupView.dismiss();
        ...
        new Handler().post(new Runnable() {
            @Override
            public void run() {
                String str = RomUtils.getRomInfo().toString() + " " + "deviceHeight：" + XPopupUtils.getScreenHeight(XpopupMainActivity.this)
                        + "  getAppHeight: "+ XPopupUtils.getAppHeight(XpopupMainActivity.this)
