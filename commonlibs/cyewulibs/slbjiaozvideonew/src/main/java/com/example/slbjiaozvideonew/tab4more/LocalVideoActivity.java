package com.example.slbjiaozvideonew.tab4more;
...
import com.example.slbjiaozvideonew.customjzvd.JzvdStdAssert;
import com.example.slbjiaozvideonew.custommedia.JZMediaSystemAssertFolder;
...
//        getSupportActionBar().setTitle(getString(R.string.local_video));
        ...
        jzvdAssertPath = findViewById(R.id.assert_path);
        localVideoPath = getExternalFilesDir(null).getAbsolutePath() + "/DCIM/Camera/activity_local_video.mp4";
