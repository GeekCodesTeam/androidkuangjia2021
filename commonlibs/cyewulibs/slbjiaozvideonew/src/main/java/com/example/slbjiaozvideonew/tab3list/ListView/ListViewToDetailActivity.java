package com.example.slbjiaozvideonew.tab3list.ListView;
...
import com.example.slbjiaozvideonew.tab3list.ListView.adapter.SmoothRecyclerViewAdapter;
import com.example.slbjiaozvideonew.utils.AutoPlayUtils;
import com.example.slbjiaozvideonew.utils.ViewAttr;

/**
 * 列表平滑进入详情页
 * <p>1.获取当前播放的JZVD添加到详情页中
 * <p>2.获取列表中JZVD的坐标，宽高，获取详情页JZVD坐标，宽高，借助ViewMoveHelper实现平移{@linkViewMoveHelper}
 *
 * @author Liberations
 */
