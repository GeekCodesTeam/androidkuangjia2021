...
import com.example.slbjiaozvideonew.tab1basic.CustomMediaActivity;
import com.example.slbjiaozvideonew.tab1basic.OrientationActivity;
import com.example.slbjiaozvideonew.tab1basic.PreloadingActivity;
import com.example.slbjiaozvideonew.tab1basic.RotationVideoSizeActivity;
import com.example.slbjiaozvideonew.tab1basic.ScreenRotateActivity;
 ...
 */
public class Fragment1Base extends Fragment implements View.OnClickListener {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        String proxyUrl = DipAndPx.getProxy().getProxyUrl(UrlsKt.getCndVideos()[0]);
        map.put("高清", proxyUrl);
