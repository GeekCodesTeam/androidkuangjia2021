package com.example.slbjiaozvideonew.Tab_3_List;
...
import com.example.slbjiaozvideonew.utils.AnimatedGifEncoder;
...
public class GifCreateHelper {
     ...
     * @param vedioUrl       视频链接
     */
    public void startGif(final long bitmapFromTime, String vedioUrl) {
        int bitmapCount = mGifPeriod / mDelay;
        final String[] picList = new String[bitmapCount];
        isDownloadComplete = false;
        final FFmpegMediaMetadataRetriever mmr = prepareFFmpegMediaMetadataRetriever(vedioUrl);
    ...
    private void checkCompleteAndDoNext(final String[] picList, boolean isCurrentSuccess) {
