...
import com.example.slbjiaozvideonew.tab3list.ListView.AutoPlayListViewActivity;
import com.example.slbjiaozvideonew.tab3list.ListView.ListViewFragmentViewPagerActivity;
import com.example.slbjiaozvideonew.tab3list.ListView.ListViewMultiHolderActivity;
import com.example.slbjiaozvideonew.tab3list.ListView.ListViewToDetailActivity;
import com.example.slbjiaozvideonew.tab3list.ListView.NormalListViewActivity;
import com.example.slbjiaozvideonew.tab3list.ListView.RecyclerViewActivity;
import com.example.slbjiaozvideonew.tab3list.ListView.tiktok.ActivityTikTok;


/**
 * Created by pengan.li on 2020/5/8.
 */
public class Fragment3List extends Fragment implements View.OnClickListener {
