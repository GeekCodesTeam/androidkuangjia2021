...
public class CustomHeaderSampleFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_elemeelm, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        linkage.addItemDecoration(LinkageRecyclerView.FOR_SECONDARY,
                new SecondaryItemDecoration(12, 12));

        View headerLayout = linkage.getHeaderLayout();
        ...
        btnClick.setOnClickListener(v -> {
            Toast.makeText(getContext(), "点击了 " + tvHeader.getText() + " - position "
                    + linkage.getPrimaryAdapter().getSelectedPosition(), Toast.LENGTH_SHORT).show();
        });
    }
    ...
    private class ElemeSecondaryAdapterConfig implements
        ...
        public int getHeaderLayoutId() {
            return R.layout.layout_custom_headerelm;
        }
