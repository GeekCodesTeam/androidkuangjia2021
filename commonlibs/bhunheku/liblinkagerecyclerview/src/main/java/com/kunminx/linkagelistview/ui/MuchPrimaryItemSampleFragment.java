 ...
 */
public class MuchPrimaryItemSampleFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_much_primary_itemelm, container, false);
    ...
    private static class MuchLinkagePrimaryAdapterConfig implements ILinkagePrimaryAdapterConfig {
    ...
    private static class MuchLinkageSecondaryAdapterConfig implements
