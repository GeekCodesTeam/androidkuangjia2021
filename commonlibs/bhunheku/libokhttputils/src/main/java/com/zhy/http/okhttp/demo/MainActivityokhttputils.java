package com.zhy.http.okhttp.demo;
...
public class MainActivityokhttputils extends AppCompatActivity {
    ...
    public class MyStringCallback extends StringCallback {
        ...
        public void onResponse(String response, int id) {
            ...
            switch (id) {
                case 100:
                    Toast.makeText(MainActivityokhttputils.this, "http", Toast.LENGTH_SHORT).show();
                    break;
                case 101:
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mainokhttputils);
        //
