...
package com.github.commonlibs.libupdateapputilsold.view;
...
//    private int totalMovedLength;
    ...
    private void initData() {
        ...
        // 已完成进度条画笔的属性
        paintInit.setColor(context.getResources().getColor(R.color.blue00AAEE));
        ...
        // 大圆画笔
        paintEndBig.setColor(context.getResources().getColor(R.color.blue00AAEE));
        ...
        paintText.setColor(context.getResources().getColor(R.color.blue00AAEE));
