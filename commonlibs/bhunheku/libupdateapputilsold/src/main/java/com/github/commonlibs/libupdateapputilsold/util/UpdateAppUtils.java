...
import com.github.commonlibs.libupdateapputilsold.customview.ConfirmDialogNew;
import com.github.commonlibs.libupdateapputilsold.feature.Callback;
import com.github.commonlibs.libupdateapputilsold.view.AppUpdateProgressDialog;
        ...
        switch (checkBy) {
            case CHECK_BY_VERSION_CODE:
                if (serverVersionCode > localVersionCode) {
                    ...
                    UpdateToastUtil.showToast(activity.getApplicationContext(), "当前版本是最新版本");
