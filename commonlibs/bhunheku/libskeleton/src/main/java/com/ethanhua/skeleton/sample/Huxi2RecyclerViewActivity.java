...
public class Huxi2RecyclerViewActivity extends AppCompatActivity {
    ...
    public static void start(Context context, String type) {
        Intent intent = new Intent(context, Huxi2RecyclerViewActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recyclerviewhuxi2);
    ...
    private void init() {
        ...
        if (TYPE_LINEAR.equals(mType)) {
            ...
            final SkeletonScreen skeletonScreen = Skeleton.bind(recyclerView)
                    ...
                    .duration(1200)
                    .count(10)
                    .load(R.layout.item_skeleton_newshuxi2)
        ...
        if (TYPE_GRID.equals(mType)) {
            ...
            final SkeletonScreen skeletonScreen = Skeleton.bind(recyclerView)
                    .adapter(adapter)
                    .load(R.layout.item_skeleton_personhuxi2)
                    .shimmer(false)
                    .show();
            recyclerView.postDelayed(new Runnable() {
                @Override
