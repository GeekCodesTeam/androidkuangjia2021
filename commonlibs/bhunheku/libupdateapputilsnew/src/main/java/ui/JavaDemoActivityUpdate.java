 ...
 * @author yk
 */
public class JavaDemoActivityUpdate extends AppCompatActivity implements View.OnClickListener {

    private String apkUrl = "http://cdn2.cdn.haier-jiuzhidao.com/libyewu-ezhibu-bxn_nation-release.apk";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateConfig.setApkSaveName("测试app");
        ...
        UpdateAppUtils
                ...
                .setCancelBtnClickListener(new OnBtnClickListener() {
                    ...
                    public boolean onClick() {
                        Toast.makeText(JavaDemoActivityUpdate.this, "取消", Toast.LENGTH_SHORT).show();
                        return false;
                    }
                })
                // 设置 立即更新 按钮点击事件
                .setUpdateBtnClickListener(new OnBtnClickListener() {
                    @Override
                    public boolean onClick() {
                        Toast.makeText(JavaDemoActivityUpdate.this, "立即更新", Toast.LENGTH_SHORT).show();
                        return false;
                    }
                }).update();
    }
