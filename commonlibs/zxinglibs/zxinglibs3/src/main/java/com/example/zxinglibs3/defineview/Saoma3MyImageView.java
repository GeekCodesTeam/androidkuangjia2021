package com.example.zxinglibs3.defineview;
 ...
 */
public class Saoma3MyImageView extends AppCompatImageView {
    private Context context;
    public Saoma3MyImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }
    public Saoma3MyImageView(Context context) {
        super(context);
        this.context = context;
    }
