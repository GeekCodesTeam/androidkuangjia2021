...
//        EventBus.getDefault().register(this)
        LongClickUtils.setLongClick(handler, enter_personalCenter, 5000) {
            startActivity(Intent(this@XCLMainActivity, PersonalCenterActivity::class.java))
            false
        }

        LongClickUtils.setLongClick(handler, enter_file, 3000) {
            try {
                val intent = Intent()
        ...
        LongClickUtils.setLongClick(handler, enter_setting, 3000) {
            try {
                val intent = Intent()
        ...
        LongClickUtils.setLongClick(handler, enter_update, 3000) {
...
//            HiosHelper.resolveAd(this@XCLMainActivity, this@XCLMainActivity, "https://www.pgyer.com/axeF")
        ...
        val sysSp = ConfApplication.APP_CONTEXT.getSharedPreferences("SystemInfo", Context.MODE_PRIVATE)
...
//      firstLayout = layout.data
        ...
        commonList.forEach {
            when (it.type) {
                "background" -> {
                    loadBackground(backgroundLayout, it.image)
                }
                ...
                "time" -> {
                    ...
                    tvDate.layoutParams = ViewGroup.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT)
...
//
                "grantmenu" -> {
                    if (firstLayout!!.isshowmenu) {
                        ...
                        tvColumn.layoutParams = ViewGroup.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT)
...
//                    setupNoticeBar()
                    ...
                    var announcementStyle = GsonUtil.stringToBean(it.style, FirstLayout.AnnouncementStyle::class.java)
...
//                    backgroundLayout.addView(noticeBar)
                    ...
                    noticeBar.marqueeView.setMaxLines(announcementStyle.lines.toInt())
                    noticeBar.marqueeView.setTextSize(announcementStyle.size.toInt())
                ...
                "billVideo" -> {
                    ...
                    playerBackground!!.layoutParams = FrameLayout.LayoutParams(it.width + DisplayUtil.dip2px(this, 2f), it.height + DisplayUtil.dip2px(this, 2f))
            ...
            ivMo.setOnClickListener { _ ->
                when (it.code) {
                    "xcl-dengta-app" -> {//灯塔App
                        try {
                            AppUtil.startOtherApp(this, getString(R.string.xcl_home_packagename_dengtadangjian))
                        } catch (e: Exception) {
                    ...
                    "xcl-dazhongribao" -> {//大众日报
                        try {
                            AppUtil.startOtherApp(this, getString(R.string.xcl_home_packagename_xinruidazhong))
                        } catch (e: Exception) {
                            Toast.makeText(this, "未安装应用", Toast.LENGTH_SHORT).show()
                        }
                    }
...
//          modularList.add(zpPlayer!!)
    ...
    private fun requestCustomerData(view: View) {
        ...
        XCLHttp.post(XCLHttpUrlMaster.CUSTOMERSERVICE, map, object : ZResponse<CustomerService>(CustomerService::class.java, mActivity, "加载中...") {
...
//          zpPlayer!!.play(playUrl, zpPlayer!!.getonReCurrentPosition())
        ...
        val usersp = ConfApplication.APP_CONTEXT.getSharedPreferences("UserInfo", Context.MODE_PRIVATE)
...
//                    }
    ...
    private fun checkVersion() {
        ...
        val map = HashMap<String, String>()
        XCLHttp.get(HttpUrlMaster.FirstPage_Version + grantId, map, object : ZResponse<CheckFirstVersion>(CheckFirstVersion::class.java, this@XCLMainActivity, "加载中...") {
    ...
    private fun initData() {
        ...
        XCLHttp.get(HttpUrlMaster.FirstPage + grantId + "/billboard", map, object : ZResponse<FirstLayout>(FirstLayout::class.java, this@XCLMainActivity, "加载中...") {
...
//                ToastUtil.toastLong("首页布局获取失败")
    ...
    private fun updateApp() {
        ...
        XCLHttp.postJson(HttpUrlMaster.UPDATEINFO, Jsonbean, object : ZResponse<UpdateBean>(UpdateBean::class.java) {
                        ...
                        if ("1" == resObj.data.updateMsg.updateStrategy) {
                            ZConfirm(this@XCLMainActivity).setTitle("版本更新  " + resObj.data.updateMsg.versionInfo + "版")
                                    ...
                                    .addSubmitListener {
                                        ...
                                        UpdateMgr.downLoadApp(this@XCLMainActivity, resObj.data.updateMsg.url)
                                        true
                                    }
                                    .addCancelListener {
                                        AppUtil.quitSystem()
    ...
    private fun requestForMainNotice() {
        ...
        XCLHttp.postJson(XCLHttpUrlMaster.XCLMainNoitceList, json, object : ZResponse<XCLMainNoticeListReplayBean>(XCLMainNoticeListReplayBean::class.java) {
    ...
    private fun initMarquee() {
        ...
        noticeBar?.marqueeView?.startWithList(titleList)
        noticeBar?.marqueeView?.setOnItemClickListener { position, _ ->
...
//        Log.i("EventBus onEvent", "video position: ${event.videoPosition}")
        var videoPosition = (if (event.videoPosition <= 5000) event.videoPosition else event.videoPosition - 5000)
