package com.fosung.xuanchuanlan.xuanchuanlan.tools;
...
//            content = (TextView) rootView.findViewById(R.id.content);
            contentImageView = (ImageView) rootView.findViewById(R.id.id_contentImage);
...
//            }
            ...
            if (builder.iamgeURL != null) {
                ImageLoaderUtils.displayImage(builder.activity, builder.iamgeURL, contentImageView);
            }
                    ...
                    switch (motionEvent.getAction()) {
                        ...
                        case MotionEvent.ACTION_UP:
                            ...
                            if(builder.isBackgroundClose){
                                if (builder.showAtLocationType.equals(GRAVITY_CENTER)) {
                                    if (touchY < pop_layout.getTop() || touchY > pop_layout.getBottom() || touchX < pop_layout.getLeft() || touchX > pop_layout.getRight()) {
                                        popupWindow.dismiss();
                                    }
...
//        }
        ...
        public Builder setIamgeURL(String iamgeURL) {
