...
import com.fosung.frameutils.util.StringUtil;
import com.fosung.xuanchuanlan.R;
import com.fosung.xuanchuanlan.xuanchuanlan.main.activity.XCLAdvertActivity;
...
public abstract class BaseActivity extends BaseFrameActivity {
    ...
    private long advertisingTime = 50 * 1000;//定时跳转广告时间
    public boolean isPlayed = true;//定时跳转广告时间
...
//        getWindow().addFlags(WindowManager.LayoutParams.FLAG_SECURE);
        ...
        //服务广播
        serviceStopReceiver = new ServiceStopReceiver();
        IntentFilter filter = new IntentFilter();
        filter.addAction("serviceStop.reportsucc");
                ...
                public void onFinish() {
                    ...
                    if (Build.VERSION.SDK_INT >= 23) {
                        if (!Settings.canDrawOverlays(getApplicationContext())) {
                            ...
                            startService(new Intent(BaseActivity.this, XCLAdvertActivity.class));
                        }
                    }
                }
            };
    ...
    public class ServiceStopReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intentAction.equals("serviceStop.reportsucc")) {
                if (countDownTimer != null){
                    countDownTimer.cancel();
                }
