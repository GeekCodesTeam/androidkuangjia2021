package com.fosung.xuanchuanlan.xuanchuanlan.widget;
...
public class MarqueeView extends ViewFlipper {
    ...
    @AnimRes
    private int inAnimResId = R.anim.anim_marquee_bottom_in;
    @AnimRes
    private int outAnimResId = R.anim.anim_marquee_top_out;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ellipsize = typedArray.getInt(R.styleable.MarqueeViewStyle_mvEllipsize,ellipsize);
        maxLines = typedArray.getInt(R.styleable.MarqueeViewStyle_mvMaxLines,maxLines);
