...
public class ShouyeFooterBean implements Serializable {
    /**
     *
     */
    ...
    public ShouyeFooterBean() {
    }

    public ShouyeFooterBean(String text_id, String text_content, int text_icon, int text_icon2, boolean enselect) {
