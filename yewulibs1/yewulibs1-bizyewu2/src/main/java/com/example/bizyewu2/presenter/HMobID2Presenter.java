...
public class HMobID2Presenter extends Presenter<HMobID2View> {
    ...
    public void get_mob_id2(int pageNum, int pageSize, String  receiveUserId, String code) {
        ...
        RetrofitNetNew.build(Bizyewu2Api.class, getIdentifier()).get_mob_id2("http://t-ums.ireign.cn/gwapi/ums/api/ums/manage/querypage", requestBody).enqueue(new Callback<HMobid2Bean>() {
            @Override
