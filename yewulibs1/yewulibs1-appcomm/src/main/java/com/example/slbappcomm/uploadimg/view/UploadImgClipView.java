 ...
 * 头像上传裁剪框
 */
public class UploadImgClipView extends View {
    ...
    public UploadImgClipView(Context context) {
        this(context, null);
    }

    public UploadImgClipView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public UploadImgClipView(Context context, AttributeSet attrs, int defStyle) {
