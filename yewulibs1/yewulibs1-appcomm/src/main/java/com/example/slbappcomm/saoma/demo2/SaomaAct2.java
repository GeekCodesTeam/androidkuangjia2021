...
public class SaomaAct2 extends AppCompatActivity implements View.OnClickListener {
            ...
            AndPermission.with(this)
                    ...
                    .onGranted(new Action<List<String>>() {
                        ...
                        public void onAction(List<String> data) {
                            Intent intent = new Intent(SaomaAct2.this, CaptureActivity.class);
                            /*ZxingConfig是配置类
                             *可以设置是否显示底部布局，闪光灯，相册，
                             * 是否播放提示音  震动
                             * 设置扫描框颜色等
...
//                                config.setScanLineColor(R.color.colorAccent);//设置扫描线的颜色 默认白色
                    ...
                    .onDenied(new Action<List<String>>() {
                        ...
                        public void onAction(List<String> data) {
                            ...
                            Toast.makeText(SaomaAct2.this, "没有权限无法扫描呦", Toast.LENGTH_LONG).show();
                        }
                    })
                    .start();
        ...
        } else if (id == R.id.fragScanBtn) {
            Intent intent = new Intent(this, SaomaAct2FragmentActivity.class);
            startActivity(intent);
        }
    }
