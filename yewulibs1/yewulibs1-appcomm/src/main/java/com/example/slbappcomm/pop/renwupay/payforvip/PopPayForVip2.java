...
// 支付弹窗
public class PopPayForVip2 extends PopupWindow {
    ...
    public PopPayForVip2() {

    }

    public PopPayForVip2(final Activity activity, int drawable1, String title_pop, final OnFinishResultClickListener mListener) {
        super(activity);
...
//        AutoSize.autoConvertDensity((Activity) activity, 375, true);
        ...
        mMenuView = inflater.inflate(R.layout.pop_payforvip2, null);
