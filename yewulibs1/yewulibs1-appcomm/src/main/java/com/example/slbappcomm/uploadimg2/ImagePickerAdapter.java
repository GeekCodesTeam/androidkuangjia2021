...
public class ImagePickerAdapter extends RecyclerView.Adapter<ImagePickerAdapter.SelectedPicViewHolder> {
    ...
    public SelectedPicViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new SelectedPicViewHolder(mInflater.inflate(R.layout.uploadimg2_list_item_image, parent, false));
    }
    ...
    public class SelectedPicViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(int position) {
            ...
            if (isAdded && position == getItemCount() - 1) {
                ...
                clickPosition = UploadPicActivity.IMAGE_ITEM_ADD;
            } else {
            ...
            iv_img.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View view) {
                    if (clickPosition == UploadPicActivity.IMAGE_ITEM_ADD) {
