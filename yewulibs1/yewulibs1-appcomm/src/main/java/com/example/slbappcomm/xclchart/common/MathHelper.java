 ...
 * @version 1.0
 */
package com.example.slbappcomm.xclchart.common;
...
//			  BigDecimal bgNum2 = new BigDecimal(Double.toString(v2));
            BigDecimal bgNum1 = BigDecimal.valueOf(v1);
            BigDecimal bgNum2 = new BigDecimal(v2 + "");
...
//            BigDecimal bgNum2 = new BigDecimal(Double.toString(v2));
            BigDecimal bgNum1 = BigDecimal.valueOf(v1);
            BigDecimal bgNum2 = BigDecimal.valueOf(v2);
