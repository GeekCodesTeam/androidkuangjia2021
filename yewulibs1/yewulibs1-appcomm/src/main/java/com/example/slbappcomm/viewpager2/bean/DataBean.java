package com.example.slbappcomm.viewpager2.bean;
...
public class DataBean {
    ...
    public static List<DataBean> getTestData() {
        ...
        list.add(new DataBean(R.drawable.image8, "相信自己,你努力的样子真的很美", 1));
        list.add(new DataBean(R.drawable.image8, "极致简约,梦幻小屋", 3));
        list.add(new DataBean(R.drawable.image8, "超级卖梦人", 3));
        list.add(new DataBean(R.drawable.image8, "夏季新搭配", 1));
        list.add(new DataBean(R.drawable.image8, "绝美风格搭配", 1));
        list.add(new DataBean(R.drawable.image8, "微微一笑 很倾城", 3));
        return list;
    }

    public static List<DataBean> getTestData2() {
        List<DataBean> list = new ArrayList<>();
        list.add(new DataBean(R.drawable.image8, "听风.赏雨", 3));
        list.add(new DataBean(R.drawable.image8, "迪丽热巴.迪力木拉提", 1));
        list.add(new DataBean(R.drawable.image8, "爱美.人间有之", 3));
        list.add(new DataBean(R.drawable.image8, "洋洋洋.气质篇", 1));
        list.add(new DataBean(R.drawable.image8, "生活的态度", 3));
        return list;
    }
    ...
    public static List<DataBean> getTestDataVideo() {
        ...
        list.add(new DataBean(R.drawable.image8, "听风.赏雨", 1));
        list.add(new DataBean(R.drawable.image8, "迪丽热巴.迪力木拉提", 1));
        list.add(new DataBean(R.drawable.image8, "爱美.人间有之", 1));
        list.add(new DataBean(R.drawable.image8, "洋洋洋.气质篇", 1));
        list.add(new DataBean(R.drawable.image8, "生活的态度", 1));
        return list;
    }
