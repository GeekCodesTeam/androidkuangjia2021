...
public final class RegexUtil {
    ...
    public static Pattern patternisVehicleNo = Pattern.compile("^[\u4e00-\u9fa5]{1}[a-zA-Z]{1}[a-zA-Z_0-9]{5}$");

    public static boolean isVehicleNo(String vehicleNo) {
        return patternisVehicleNo.matcher(vehicleNo)
                .find();
     ...
     *               、150、151、152、157（TD专用）、158、159、187（未启用）、188（TD专用）、198</p>
     *               <p>联通的号段：130、131、132、155、156（世界风专用）、166、185（未启用）、186（3g）</p>
     *               <p>电信的号段：133、153、180（未启用）、189、199</p>
     *               <p>虚拟运营商好短：17</p>
     * @return 验证成功返回true，验证失败返回false
     */
