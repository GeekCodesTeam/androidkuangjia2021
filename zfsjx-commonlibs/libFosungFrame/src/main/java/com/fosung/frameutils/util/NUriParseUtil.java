...
public class NUriParseUtil {
    ...
    public static Uri getUriFromFile(File file) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            return FileProvider.getUriForFile(AppUtils.get(), getProviderName(), file);
        }
    }
    ...
    public static File getFileFromUri(String dataType, Uri uri) {
        ...
        if (ContentResolver.SCHEME_CONTENT.equals(scheme)) {
            ...
            Cursor cursor = AppUtils.get().getContentResolver()
    ...
    public static Uri getImageContentUri(File imageFile) {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            ...
            if (imageFile.exists()) {
                ...
                return AppUtils.get().getContentResolver()
    ...
    private static String getProviderName() {
        return (applicationId == null ? AppUtils.get().getPackageName() : applicationId) + ".fosungframe_fileprovider";
    }
