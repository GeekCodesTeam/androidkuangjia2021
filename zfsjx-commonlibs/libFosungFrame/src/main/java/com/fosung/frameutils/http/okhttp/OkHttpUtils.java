...
package com.fosung.frameutils.http.okhttp;

import android.os.Handler;
import android.os.Looper;

import com.fosung.frameutils.http.okhttp.builder.GetBuilder;
import com.fosung.frameutils.http.okhttp.builder.HeadBuilder;
import com.fosung.frameutils.http.okhttp.builder.OtherRequestBuilder;
import com.fosung.frameutils.http.okhttp.builder.PostFileBuilder;
import com.fosung.frameutils.http.okhttp.builder.PostFormBuilder;
import com.fosung.frameutils.http.okhttp.builder.PostStringBuilder;
import com.fosung.frameutils.http.okhttp.callback.Callback;
                       ...
                       public void onResponse(final Call call, final Response response) {
                           try {
                               ...
                               if (!finalCallback.validateReponse(response)) {
                                   sendFailResultCallback(response.code(), call, new IOException("request failed , response's code is : " + response.code()), 
                                           finalCallback);
                                   return;
                               }
