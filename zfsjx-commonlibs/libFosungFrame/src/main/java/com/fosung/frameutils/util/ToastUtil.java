...
import com.fosung.frameutils.app.AppUtils;
...
public class ToastUtil {
    ...
    public static void toastShort(int strRes) {
        if (null == AppUtils.get()) {
            return;
        }
        toastShow(AppUtils.get().getString(strRes), Toast.LENGTH_SHORT, null);
    }
    ...
    public static void toastLong(int strRes) {
        ...
        toastShow(AppUtils.get().getString(strRes), Toast.LENGTH_LONG, null);
    }
     ...
     * @param able			显示的图片
     */
    private static void ToastShowWithDrawable(String strInfo, int nKeepTime, Drawable able) {
        try {
            if (null == AppUtils.get()) {
                return;
            } else if (nKeepTime < 0) {
            ...
            if (toast != null) {
                ...
                toast = Toast.makeText(AppUtils.get(), strInfo, nKeepTime);
                ...
                toast.setView(view);*/
                toast.setGravity(Gravity.BOTTOM, 0, DisplayUtil.dip2px(AppUtils.get(), 45));
            }
            toast.show();
        } catch (Exception e) {
    ...
    static class MYHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            if (msg != null && msg.arg1 == 0 && msg.obj != null) {
                ...
                ToastShowWithDrawable(info.msg, info.nKeepTime, info.able);
            }
        }
    }
