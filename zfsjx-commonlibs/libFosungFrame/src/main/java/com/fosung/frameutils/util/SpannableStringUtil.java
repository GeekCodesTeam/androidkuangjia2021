...
public class SpannableStringUtil {
    ...
    public static SpannableString textSize(String str, String textSizeStr, int textSize) {
        textSize = DisplayUtil.sp2px(AppUtils.get(), textSize);
    ...
    public static class Builder {
        ...
        public Builder style(int start, int end, int tetxtApperence) {
            spannableString.setSpan(new TextAppearanceSpan(AppUtils.get(), tetxtApperence), start, end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
            return this;
        }
