...
package com.fosung.frameutils.permission;
...
public abstract class PermissionsResultAction {
    ...
    @CallSuper
    protected synchronized final boolean onResult(final  String permission, int result) {
    ...
    @SuppressWarnings("WeakerAccess")
    @CallSuper
    protected synchronized final boolean onResult(final  String permission, Permissions result) {
    ...
    @SuppressWarnings("WeakerAccess")
    @CallSuper
    protected synchronized final void registerPermissions( String[] perms) {
