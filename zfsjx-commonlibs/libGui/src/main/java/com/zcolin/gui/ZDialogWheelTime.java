...
public class ZDialogWheelTime extends ZDialog<ZDialogWheelTime> implements View.OnClickListener, OnWheelChangedListener, OnWheelScrollListener {
    ...
    public static ZDialogWheelTime instance(Context context,  int layoutId) {
     ...
     * @param context
     */
    public ZDialogWheelTime(Context context,  int layoutId) {
     ...
     * 设置中线颜色
     */
    public ZDialogWheelTime setCenterLineColor( int color) {
