...
public class ZDialogWheelDate extends ZDialog<ZDialogWheelDate> implements View.OnClickListener, OnWheelChangedListener, OnWheelScrollListener {
    ...
    public static ZDialogWheelDate instance(Context context,  int layoutId) {
     ...
     * @param context
     */
    public ZDialogWheelDate(Context context,  int layoutId) {
     ...
     * 设置中线颜色
     */
    public ZDialogWheelDate setCenterLineColor( int color) {
