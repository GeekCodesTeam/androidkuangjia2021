 ...
 * 自定义上有横条动画的TabView
 *
 * @deprecated 建议使用{@link {@link com.google.android.material.tabs.TabLayout} }
 */
public class ZTabView extends RelativeLayout implements OnClickListener, ViewPager.OnPageChangeListener {
    ...
    private ViewPager.OnPageChangeListener pagerChangeListener;            //ViewPager切换时回调
