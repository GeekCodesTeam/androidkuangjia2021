...
public class ZDialog<T> extends Dialog {
     ...
     */
    public ZDialog(Context context,  int layResID) {
        super(context);
     ...
     * @param layResID layoutId
     */
    public ZDialog(Context context,  int layResID,  int theme) {
        super(context, theme);
        setContentView(layResID);
        setLayout(ZUIHelper.getScreenWidth(context) / 6 * 5, 0);
    }
     ...
     * @param view view
     */
    public ZDialog(Context context, View view,  int theme) {
        super(context, theme);
        setContentView(view);
        setLayout(ZUIHelper.getScreenWidth(context) / 6 * 5, 0);
    }
     ...
     */
    public T setDialogBackground( int resBg) {
        this.resBg = resBg;
        return (T) this;
    }
