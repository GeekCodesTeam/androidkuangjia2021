...
public class HMobIDPresenter extends Presenter<HMobIDView> {
    ...
    public void get_mob_id() {
        ...
        RetrofitNetNew.build(Biz1Api.class, getIdentifier()).get_mob_id("http://t-ums.ireign.cn/gwapi/ums/api/ums/terminal/bind", requestBody).enqueue(new Callback<Object>() {
            @Override
