...
public class SplashView extends FrameLayout {
    ...
    private static final int skipButtonMarginInDip = 36;
    ...
    void initComponents() {
        splashSkipButtonBg.setShape(GradientDrawable.RECTANGLE);
        splashSkipButtonBg.setCornerRadius(30);
//        splashSkipButtonBg.setSize(150,80);
        splashSkipButtonBg.setColor(Color.parseColor("#66333333"));

        splashImageView = new ImageView(mActivity);
        splashImageView.setScaleType(ImageView.ScaleType.FIT_XY);
        splashImageView.setBackgroundColor(ContextCompat.getColor(mActivity, R.color.white));
        ...
        LayoutParams skipButtonLayoutParams = new LayoutParams(skipButtonSize + 60, skipButtonSize / 2);
        ...
        skipButton.setTextColor(ContextCompat.getColor(mActivity, R.color.white));
...
//        skipButton.setText(String.format("跳过\n%d s", duration));
        skipButton.setText(String.format("跳过 %d s", duration));
    }
