...
//    private int resId = R.array.light_anim; //图片资源
    private int resId = R.drawable.iv_loading_animationlist; //图片资源
...
//    private int[] mProgressAnimFrames = getData(resId);
     ...
     */
    public FramesSequenceAnimation createProgressDialogAnim(ImageView imageView, boolean isLoop) {
        return new FramesSequenceAnimation(imageView, getData(resId), FPS, isLoop);
    }
    ...
    public FramesSequenceAnimation createProgressDialogAnim(ImageView imageView) {
        return new FramesSequenceAnimation(imageView, getData(resId), FPS, true);
    }
    ...
    public class FramesSequenceAnimation {
        ...
        public FramesSequenceAnimation(ImageView imageView, int[] frames, int fps, boolean isLoop) {
        ...
        public FramesSequenceAnimation(ImageView imageView, int[] frames, int fps) {
            this(imageView, frames, fps, true);
        }
        ...
        public synchronized void start() {
            ...
            Runnable runnable = new Runnable() {
                ...
                public void run() {
                    ...
                    if (!mShouldRun || imageView == null || (!mIsLoop && mIndex == mFrames.length - 1)) {
                        mIsRunning = false;
