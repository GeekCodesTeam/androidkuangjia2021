...
interface LxICoolViewPagerFeature {
    /**
     * 设置滑动方向
     *
     * @param scrollMode
     */
    void setScrollMode(LxCoolViewPager.ScrollMode scrollMode);
     ...
     */
    void setAutoScrollDirection(LxCoolViewPager.AutoScrollDirection autoScrollDirection);
