...
import com.example.slbappcomm.xclchart.renderer.axis.RoundAxis;
import com.example.slbappcomm.xclchart.renderer.axis.RoundAxisRender;
...
import com.example.slbappcomm.xclchart.renderer.plot.Pointer;
import com.example.slbappcomm.xclchart.renderer.plot.PointerRender;
...
public class DialChart  extends CirChart {
	 ...
	 */
	public void addLineAxis(XEnum.Location location , float radiusPercentage)
