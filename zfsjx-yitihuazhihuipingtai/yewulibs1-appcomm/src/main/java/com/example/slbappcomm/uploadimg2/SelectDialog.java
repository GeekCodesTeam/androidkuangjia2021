...
public class SelectDialog extends Dialog implements OnClickListener, OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = getLayoutInflater().inflate(R.layout.uploadimg2_view_dialog_select,
                null);
    ...
    private class DialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (null == convertView) {
                ...
                convertView = layoutInflater.inflate(R.layout.uploadimg2_view_dialog_item, null);
...
//                mFirstItemColor = ContextCompat.getColor(mActivity, R.color.blue33b5e5);
                mFirstItemColor = mActivity.getResources().getColor(R.color.blue33b5e5);
                mOtherItemColor = mActivity.getResources().getColor(R.color.blue33b5e5);
            }
            if (1 == mStrings.size()) {
