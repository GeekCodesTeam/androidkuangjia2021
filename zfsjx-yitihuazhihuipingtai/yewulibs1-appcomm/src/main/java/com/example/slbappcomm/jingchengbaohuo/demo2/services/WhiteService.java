package com.example.slbappcomm.jingchengbaohuo.demo2.services;
...
public class WhiteService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Intent activityIntent = new Intent(AppUtils.getAppPackageName() + ".hs.act.slbapp.JingChengActivity2");
