...
//        IndexConfig.DEFAULT_PAGE_INDEX = 1;
    ...
    private static void registerFragments(SparseArrayCompat<Class<? extends SlbBaseFragment>> sIndexFragments) {
        sIndexFragments.put(R.id.demo2_page_0_item_1, MkDemo2Fragment1.class);//菜谱
        sIndexFragments.put(R.id.demo2_page_0_item_2, MkDemo2Fragment2.class);//视频
