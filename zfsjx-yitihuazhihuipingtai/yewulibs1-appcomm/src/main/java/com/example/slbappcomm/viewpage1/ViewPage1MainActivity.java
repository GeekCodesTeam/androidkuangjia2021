...
public class ViewPage1MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewpage1_main);
        ...
        mBottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (itemId == R.id.menu_item_home) {
                    showFragment(FRAGMENT_HOME);
                } else if (itemId == R.id.menu_item_knowledgesystem) {
                    showFragment(FRAGMENT_KNOWLEDGESYSTEM);
                } else if (itemId == R.id.menu_item_project) {
