...
public class WebViewItem5 extends BaseActWebFragment {
    ...
    protected int getLayoutId() {
        return R.layout.activity_refresh_webview5;
    }
...
//                return mAgentWeb.getWebCreator().getWebView().getScrollY() == 0;
    ...
    protected ViewGroup getAgentWebParent() {
        return (ViewGroup) getActivity().findViewById(R.id.ll_base_container5);
    }
