...
import com.example.bizyewu1.presenter.CheckverionPresenter;
import com.example.bizyewu1.view.CheckverionView;
import com.example.libappmob.MOBIDservices;
...
//import com.example.yewulibs_demo1_appindex.services.MOBIDservices;
import com.example.yewulibs_demo1_appindex.services.LocationService;
...
//                        }
                    ...
                    if (!TextUtils.isEmpty(intent.getStringExtra("color"))) {
                        WebStatusBarUtil.setColorNoTranslucent(ShouyeActivity.this, Color.parseColor(intent.getStringExtra("color")));
                    }
                }
            } catch (Exception e) {
            }
    ...
    protected void onRestart() {
        super.onRestart();
        MyLogUtil.e("Log", "onRestart");
//        mFragment1.getCate("",false);
    }
...
//                            ToastUtils.showLong("被永久拒绝授权，请手动授予定位权限");
                            ...
                            XXPermissions.startPermissionActivity(ShouyeActivity.this, permissions);
                            return;
                        }
    ...
    private void findview() {
        ...
        tv1.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                BanbenCommonUtils.changeUrl2(ShouyeActivity.this);
                return false;
            }
        });
...
//                if (checked) {//全屏状态
//                    WebStatusBarUtil.setColorNoTranslucent(ShouyeActivity.this, Color.parseColor("#3394FD"));
//                    menu_group.setVisibility(View.VISIBLE);
//                    checked = false;
//                } else {//非全屏状态
//                    WebStatusBarUtil.setColorNoTranslucent(ShouyeActivity.this, Color.parseColor("#002B70"));
//                    menu_group.setVisibility(View.GONE);
//                    checked = true;
//                }
