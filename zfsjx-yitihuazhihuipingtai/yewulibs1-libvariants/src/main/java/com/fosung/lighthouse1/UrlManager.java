package com.fosung.lighthouse1;
...
public class UrlManager {
    ...
    //测试
    public static String TEST_SERVER_ISERVICE_NEW1 = SPUtils.getInstance().getString(default_url1key, "http://192.168.43.167");
...
//    public static String TEST_SERVER_ISERVICE_NEW2 = "http://49.4.7.45:7799";
    //预生产
    public static String PREPROD_SERVER_ISERVICE_NEW1 = SPUtils.getInstance().getString(default_url1key, "http://192.168.43.167");
...
//    public static String PREPROD_SERVER_ISERVICE_NEW2 = "http://49.4.1.81:7799";
    //线上
    public static String OL_SERVER_ISERVICE_NEW1 = SPUtils.getInstance().getString(default_url1key, "http://172.20.234.167");
    public static String OL_SERVER_ISERVICE_NEW2 = SPUtils.getInstance().getString(default_url2key, "http://172.20.234.167");
