...
public class WebViewItem4 extends BaseActWebFragment {
    ...
    protected int getLayoutId() {
        return R.layout.activity_refresh_webview4;
    }
...
//                return mAgentWeb.getWebCreator().getWebView().getScrollY() == 0;
    ...
    protected ViewGroup getAgentWebParent() {
        return (ViewGroup) getActivity().findViewById(R.id.ll_base_container4);
    }
