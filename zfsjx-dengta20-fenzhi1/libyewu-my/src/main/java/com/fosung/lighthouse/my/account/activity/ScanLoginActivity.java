...
import com.geek.zxinglibs3.Saoma3CommonScanActivity;
 ...
 */
public final class ScanLoginActivity extends Activity implements ScanListener, View.OnClickListener {
...
//        }
        ...
        //构造出扫描管理器
        scanManager = new ScanManager(this, scanPreview, scanContainer, scanCropView, scanLine, DecodeThread.QRCODE_MODE, this);
    }
...
//		Toast.makeText(that, "result="+rawResult.getText(), Toast.LENGTH_LONG).show();
        ...
        bundle1.putExtra("result", rawResult.getText());
        setResult(RESULT_OK, bundle1);
        finish();
//      rescan.setVisibility(View.VISIBLE);
//      scan_image.setVisibility(View.VISIBLE);
