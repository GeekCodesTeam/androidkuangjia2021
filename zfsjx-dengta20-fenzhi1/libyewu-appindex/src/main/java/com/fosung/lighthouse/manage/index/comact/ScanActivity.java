 ...
 */
package com.fosung.lighthouse.manage.index.comact;
...
//		Toast.makeText(that, "result="+rawResult.getText(), Toast.LENGTH_LONG).show();
        ...
        IndexJump.Companion.jumpPcLoginAct(this, rawResult.getText());
        finish();
//        Intent intent = new Intent(this, LoginPcAct.class);
