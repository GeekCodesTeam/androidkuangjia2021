package com.fosung.lighthouse.manage.index.logindemo;
...
//                url1 = "hios://" + AppUtils.getAppPackageName() + ".hs.act.slbapp.AdCommLoginAct{act}?act={i}1&sku_id={s}2a&category_id={s}3a&condition=login";
                ...
                SlbLoginUtil.get().loginTowhere(AdLoginImgActDemo.this, new Runnable() {
                    @Override
                    public void run() {
                        HiosHelper.resolveAd(AdLoginImgActDemo.this, AdLoginImgActDemo.this, url1);
                    }
                });
