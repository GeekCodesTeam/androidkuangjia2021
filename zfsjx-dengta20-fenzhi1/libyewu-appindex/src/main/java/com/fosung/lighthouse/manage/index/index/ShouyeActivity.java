...
import com.fosung.lighthouse.manage.index.my.fragment.MyFragement;
...
//    private UpdateAppReceiver updateAppReceiver;// 强制升级
    ...
    private MyFragement mMyFragment; //
...
//        }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            mMyFragment = (MyFragement) mFragmentManager.findFragmentByTag(LIST_TAG4);
        }
...
//                RichText.recycle();
    ...
    private void addList() {
        mList.add(new ShouyeFooterBean(id1, "代办", R.drawable.index_tab1_normal, R.drawable.index_tab1_select, false));
        mList.add(new ShouyeFooterBean(id2, "应用", R.drawable.index_tab2_normal, R.drawable.index_tab2_select, false));
        mList.add(new ShouyeFooterBean(id3, "消息", R.drawable.index_tab3_normal, R.drawable.index_tab3_select, false));
        mList.add(new ShouyeFooterBean(id4, "我的", R.drawable.index_tab4_normal, R.drawable.index_tab4_select, false));
    }
    ...
    private void showFragment(final String tag, final boolean isrefresh) {
        ...
        if (tag.equalsIgnoreCase(id1)) {
            ...
            if (mMyFragment == null) {
                mMyFragment = new MyFragement();
                Bundle args = new Bundle();
                args.putString("tablayoutId", tag);
                mMyFragment.setArguments(args);
                transaction.add(R.id.container, mMyFragment, LIST_TAG4);
            } else {
                transaction.show(mMyFragment);
                mMyFragment.getCate(tag, isrefresh);
            }
        }
