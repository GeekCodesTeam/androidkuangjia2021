...
import com.fosung.lighthouse.manage.index.adapters.ShouyeF4Adapter1;
import com.fosung.lighthouse.manage.index.adapters.ShouyeF4Bean1;
...
//                    }
                    // test2
//                    String savepath1 = LoadUtils.setpath1(getActivity(), "libyewu-ezhibu-bxn_nation-release.apk");
//                    PluginManager.getInstance().init(getActivity());
//                    PluginManager.getInstance().loadPluginApk(savepath1);
//                    Bundle bundle = new Bundle();
//                    bundle.putString(PluginConst.query1, "MainAct传值");
//                    bundle.putString(PluginConst.DEX_PATH, savepath1);
//                    bundle.putString(PluginConst.REALLY_ACTIVITY_NAME, "com.fosung.lighthouse.ezhibu.EzhibuAct");
//                    bundle.putInt(PluginConst.LAUNCH_MODEL, PluginConst.LaunchModel.STANDARD);
//                    PluginManager.getInstance().startActivity(getActivity(), bundle);
    ...
    private void retryData() {
        ...
        mList1.add(new ShouyeF4Bean1("66", AppUtils.getAppPackageName() + ".hs.act.slbapp.SearchListActivity", "hios", "灯塔通平台", false));
