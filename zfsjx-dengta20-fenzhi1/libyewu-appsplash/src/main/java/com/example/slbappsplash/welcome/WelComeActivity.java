...
//                        startActivity(new Intent(AppUtils.getAppPackageName() + ".hs.act.slbapp.DengLuActivity"));
                        startActivity(new Intent(AppUtils.getAppPackageName() + ".hs.act.slbapp.UserLoginAct"));
                    } else {
                        jump();
                    }
                    finish();
...
//        finish();
    ...
    private void jump() {
        ...
        if (true) {
//            Intent loginIntent = new Intent(AppUtils.getAppPackageName() + ".hs.act.slbapp.DengLuActivity");
            Intent loginIntent = new Intent(AppUtils.getAppPackageName() + ".hs.act.slbapp.UserLoginAct");
//            Intent loginIntent = new Intent(AppUtils.getAppPackageName() + ".hs.act.slbapp.ShouyeActivity");
