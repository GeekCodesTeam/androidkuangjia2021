...
public class CZBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
     ...
     */
    public CZBottomSheetBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public boolean onLayoutChild(CoordinatorLayout parent, V child, int layoutDirection) {
        ...
        if (mState == STATE_EXPANDED) {
            ...
            ViewCompat.offsetTopAndBottom(child, mHalfHeight  > 0 ? mHalfHeight : mParentHeight / 2);
        }
...
//        }
    ...
    public final void setState(final @State int state) {
        ...
        if (mViewRef == null) {
            ...
            if (state == STATE_COLLAPSED || state == STATE_EXPANDED ||
                    (mHideable && state == STATE_HIDDEN || state == STATE_HALF_EXPANDED)) {
                mState = state;
            }
            return;
        }
    ...
    void startSettlingAnimation(View child, int state) {
        ...
        if (state == STATE_COLLAPSED) {
            ...
            top = mHalfHeight > 0 ? mHalfHeight : mParentHeight / 2;
...
//            }
            ...
            targetState = STATE_SETTLING;
            if (yvel != 0) {//重新处理
                overScroller.fling(releasedChild.getLeft(), releasedChild.getTop(), 0, (int) yvel
                        , 0, 0, mMinOffset, mMaxOffset);
    ...
    /**
     * A utility function to get the {@link CZBottomSheetBehavior} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link CZBottomSheetBehavior}.
     * @return The {@link CZBottomSheetBehavior} associated with the {@code view}.
     */
    @SuppressWarnings("unchecked")
    public static <V extends View> CZBottomSheetBehavior<V> from(V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof CZBottomSheetBehavior)) {
            throw new IllegalArgumentException(
                    "The view is not associated with BottomSheetBehavior");
        }
        return (CZBottomSheetBehavior<V>) behavior;
    }
