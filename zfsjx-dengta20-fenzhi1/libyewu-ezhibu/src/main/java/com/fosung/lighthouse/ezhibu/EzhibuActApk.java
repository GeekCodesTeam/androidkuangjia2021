...
public class EzhibuActApk extends SlbBaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.tv1).setOnClickListener(v -> {
            // 是否显示launch图标
            IconUtils.set_alias(EzhibuActApk.this, strings, strings[0], false);
        });
        findViewById(R.id.tv2).setOnClickListener(v -> {
            // 是否显示launch图标
            IconUtils.set_alias(EzhibuActApk.this, strings, strings[0], true);
        });
//        DeviceUtil.getUUID();
    }
    ...
    protected int getLayoutId() {
        return R.layout.activity_main_ezhibuapk;
    }
