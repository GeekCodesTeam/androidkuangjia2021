package com.fosung.lighthouse.messages;
...
public class MessagesAct extends AppCompatActivity {
    ...
    private String[] strings = new String[]{
            "com.fosung.lighthouse.messages.DefaultAlias"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.tv1).setOnClickListener(v -> {
            // 是否显示launch图标
            IconUtils.set_alias(MessagesAct.this, strings, strings[0], false);
        });
        findViewById(R.id.tv2).setOnClickListener(v -> {
            // 是否显示launch图标
            IconUtils.set_alias(MessagesAct.this, strings, strings[0], true);
        });
//        DeviceUtil.getUUID();
    }
}