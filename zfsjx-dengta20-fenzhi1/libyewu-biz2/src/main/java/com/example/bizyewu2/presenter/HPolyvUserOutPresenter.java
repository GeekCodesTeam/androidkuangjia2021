...
public class HPolyvUserOutPresenter extends Presenter<HPolyvUserInView> {
    ...
    public void get_PolyvUserOut(String id,
        ...
        RetrofitNetNew.build(Bizyewu2Api.class, getIdentifier()).get_PolyvUserOut(
                BuildConfigyewu.SERVER_ISERVICE_NEW1 + "/api/live/viewer/statistics/watchEnd",
