...
public class EduResDetailPresenter extends Presenter<EduResDetailView> {
    ...
    public static final String GET_EDU_DETAIL  = "/api/resource/av/get";
    ...
    public void getEduResDetailRequest(String id, String orgId) {
        ...
        requestData.put("auditStatus", id);
        requestData.put("orgId", orgId);

        RequestBody requestBody = RequestBody.create(MediaType.parse("application/json;charset=utf-8"), requestData.toString());

        RetrofitNetNew.build(BizEduResApi.class, getIdentifier()).getEduResDetail(BuildConfigyewu.SERVER_ISERVICE_NEW1 + GET_EDU_DETAIL,  requestBody)
            ...
            public void onResponse(Call<EduResourceDetailBean> call, Response<EduResourceDetailBean> response) {
                ...
                if (!response.body().isSuccess()) {
                    getView().OnEduResDetailFail(response.body().getMsg());
                    return;
                }
