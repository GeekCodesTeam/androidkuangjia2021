package com.fosung.lighthouse.tongxunlu;
...
public class TongxunluAct extends AppCompatActivity {

    private String[] strings = new String[]{
            "com.fosung.lighthouse.tongxunlu.DefaultAlias"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main_tongxunlu);
        // 方法1接收
        ...
        findViewById(R.id.tv1).setOnClickListener(v -> {
            // 是否显示launch图标
            IconUtils.set_alias(TongxunluAct.this, strings, strings[0], false);
        });
        findViewById(R.id.tv2).setOnClickListener(v -> {
            // 是否显示launch图标
            IconUtils.set_alias(TongxunluAct.this, strings, strings[0], true);
        });
//        DeviceUtil.getUUID();
    }
}