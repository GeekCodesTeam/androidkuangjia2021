...
import com.hs.zhidaokeyboard.voiceutil.voicemanage.AudioManager;
import com.hs.zhidaokeyboard.voiceutil.voicemanage.DialogManager;
...
public class AudioRecorderButton extends Button implements AudioManager.AudioStateListener {
    ...
    private static final String dir_videos = Environment.getExternalStorageDirectory()
            + "/geek_recorder_videos";
        ...
        public void run() {
            while (isRecording) {
                try {
                    Thread.sleep(100);
                    mTime += 0.1f;
                    if (mTime > DialogManager.MAX_SECOND) {
                        isRecording = false;
