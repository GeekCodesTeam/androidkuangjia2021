...
public class LxFloatRelativeLayout extends RelativeLayout {
...
//    private float y = Y_INT;
    ...
    private WindowManager wm = (WindowManager) App.get().getSystemService(Context.WINDOW_SERVICE);
    ...
    public LxFloatRelativeLayout(Context context) {
        super(context);
//        setPadding(30, 30, 30, 30);
        ...
        LayoutInflater.from(context).inflate(R.layout.layout_float_relative_lx, this);
